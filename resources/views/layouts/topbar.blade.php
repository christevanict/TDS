<header class="top-header">
    ...
    <div class="btn-toggle me-auto">
        <a href="javascript:;"><i class="material-icons-outlined">menu</i></a>
    </div>
    <h5 class="me-5">Terra Data Solusi</h5>
                ...
                <div class="search-list d-flex flex-column gap-2">
                  <div class="search-list-item d-flex align-items-center gap-3">
                    <div class="memmber-img">
                      <img src="{{ URL::asset('build/images/01.png') }}" width="32" height="32" class="rounded-circle" alt="">
                    </div>
                    <div class="">
                  ...
                  <div class="search-list-item d-flex align-items-center gap-3">
                    <div class="memmber-img">
                      <img src="" width="32" height="32" class="rounded-circle" alt="">
                    </div>
                    <div class="">
      ...
      <ul class="navbar-nav gap-1 nav-right-links align-items-center">
        <li class="nav-item d-none d-lg-none mobile-search-btn">
          <a class="nav-link" href="javascript:;"><i class="material-icons-outlined">search</i></a>
        </li>
        <li class="nav-item d-none dropdown position-static">
              ...
              <div>
                <a class="dropdown-item border-bottom py-2" href="javascript:;">
                  <div class="d-flex align-items-center gap-3">
                    <div class="">
                      <img src="" class="rounded-circle" width="45" height="45" alt="">
                    </div>
                    <div class="">
        ...
        <li class="nav-item ms-auto dropdown">
          <a href="javascrpt:;" class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown">
             <img src="{{ URL::asset('build/images/01.png') }}" class="rounded-circle p-1 border" width="45" height="45">
          </a>

          <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
            <span class="dropdown-item d-flex align-items-center gap-2 py-2" ><i
                class="material-icons-outlined">person</i>{{Auth::user()->fullname}}</span>
            <form method="POST" action="{{ url('/TDS/auth/logout') }}" x-data>
                @csrf
