        ...
        @else
            <table class="trial-balance-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="9" style="text-align: left;"><h2 style="font-size: 12px;">{{ $customerName }}</h2></td>
                    </tr>
                    <tr>
                        <td>SAWAL</td>
                        <td></td>
                    ...
                    @foreach ($report['debts'] as $rei)
                        ...
                        <tr>
                            ...
                            <td class="aging">{{ number_format($rei->debt_balance, 0) }}</td>
                            <td class="aging">
                                @if($agingGroup == '0')
                                    {{ number_format($rei->debt_balance) }}
                                    @php $grandTotalNotYetDue += $rei->debt_balance; @endphp
                                @else
                                    0
                                @endif
                            </td>
                            <td class="aging">
                                @if($agingGroup == '1-30')
                                    {{ number_format($rei->debt_balance) }}
                                    @php $grandTotal1to30Days += $rei->debt_balance; @endphp
                                @else
                                    0
                                @endif
                            </td>
                            <td class="aging">
                                @if($agingGroup == '31-60')
                                    {{ number_format($rei->debt_balance) }}
                                    @php $grandTotal31to60Days += $rei->debt_balance; @endphp
                                @else
                                    0
                                @endif
                            </td>
                            <td class="aging">
                                @if($agingGroup == '61-90')
                                    {{ number_format($rei->debt_balance) }}
                                    @php $grandTotal61to90Days += $rei->debt_balance; @endphp
                                @else
                                    0
                                @endif
                            </td>
                            <td class="aging">
                                @if($agingGroup == 'over_90')
                                    {{ number_format($rei->debt_balance) }}
                                    @php $grandTotalOver90Days += $rei->debt_balance; @endphp
                                @else
                                    0
                                @endif
                            </td>
                    ...
                    <tr>
                        <td colspan="3" style="text-align: right">Total for {{ $customerName }}</td>
                        ...
                        <td class="aging">{{ number_format($report['aging']['over_90']) }}</td>
                    </tr>
