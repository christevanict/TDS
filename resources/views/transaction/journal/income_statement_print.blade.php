...
<head>
    ...
    <style>
        ...
        .income-statement-table th:nth-child(1),
        .income-statement-table td:nth-child(1) {
...
<body>
    <div class="container">
        ...
        @if (empty($groupedData) || $groupedData->isEmpty())
            <div class="no-data">
                <p>No income statement data available for the selected period.</p>
            </div>
        @else
        <table class="income-statement-table">
            ...
            <tbody>
                ...
                @foreach ($groupedData as $accountTypeName => $subTypes)
                    ...
                    <!-- Account Type Total -->
                    <tr class="total-row">
                        <td colspan="2" style="text-align: right;"><strong> {{ $accountTypeName }}:</strong></td>
                        <td class="amount" style="text-align: right;"><strong>{{ number_format($accountTypeTotal, 2) }}</strong></td>
                    </tr>
                @endforeach
                <!-- Grand Total -->
                <tr class="grand-total-row">
                    <td colspan="2" style="text-align: right;"><strong>Total Laba / Rugi :</strong></td>
                    <td class="amount" style="text-align: right;"><strong>{{ number_format($grandTotal, 2) }}</strong></td>
                </tr>
            </tbody>
        </table>
        @endif
