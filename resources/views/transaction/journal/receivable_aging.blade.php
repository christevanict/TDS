...
@section('content')
<x-page-title title="Journal" pagetitle="Laporan Umur Piutang" />
<hr>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="form-container">
            <form method="GET" action="{{ route('transaction.journal.receivableAging') }}" class="form-inline justify-content-start">
        ...
        @else
            <div class="table-responsive">
                ...
                <div class="row mb-3 d-none">
                    <div class="">
                        <a href="{{ route('transaction.journal.ReceivableAgingPdf', ['start_date' => $startDate, 'end_date' => $endDate]) }}" target="_blank">
            ...
            buttons: [
                ...
                },
                {
                    ...
                    filename: function() {
                        ...
                        return 'TerraDataSolusi_LaporanUmurPiutang_'+ dateFrom + '_to_' + dateTo;
                    },
                    exportOptions: {
                        columns: [1, 2, 3, 4, 5, 6, 7, 8]
                    }
