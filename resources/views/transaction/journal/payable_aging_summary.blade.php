...
@section('title', 'Ringkasan Umur Hutang')
...
@section('content')
<x-page-title title="Ringkasan Umur Hutang" pagetitle="Ringkasan Umur Hutang" />
<hr>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="form-container">
            <form method="GET" action="{{ route('transaction.payableAgingSummary') }}" class="form-inline justify-content-start">
            ...
            buttons: [
                ...
                },
                {
                    ...
                    filename: function() {
                        ...
                        return 'TerraDataSolusi_RingkasanUmurHutang_'+ dateFrom + '_to_' + dateTo;
                    },
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5, 6]
                    }
                },
                {
                    ...
                    customize: function(doc) {
                        ...
                        doc.content = [{
                            text: [
                                { text: 'Laporan Ringkasan Umur Hutang\n', fontSize: 14, bold: true },
