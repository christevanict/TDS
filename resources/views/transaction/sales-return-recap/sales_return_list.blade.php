...
@section('content')
<x-page-title title="REKAP {{__('Sales Return')}}" pagetitle="REKAP {{__('Sales Return')}} {{__('Information')}}" />
<hr>

<div class="card">
    <div class="card-body">
        <h6 class="mb-2 text-uppercase">REKAP {{__('Sales Return')}} {{__('Information')}}</h6>
        <a class="btn btn-primary mb-3 @if(!in_array('create', $privileges)) disabled @endif" href="{{ route('transaction.sales_return_recap.create') }}">
            Tambah Baru
        </a>
            ...
            <table id="example" class="table table-hover table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr class="clickable-row">
                        ...
                        <td>
                            <a href="{{ route('transaction.sales_return_recap.edit', $generals->id) }}" class="btn btn-warning btn-edit"><i class="material-icons-outlined">edit</i></a>
