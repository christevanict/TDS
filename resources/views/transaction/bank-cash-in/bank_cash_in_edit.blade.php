                        ...
                        <tbody>
                            @foreach($bankCashIn->details as $detail)
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" step="0.01" name="details[{{ $loop->index }}][nominal]" class="form-control text-end nominal" required value="{{ old('details.' . $loop->index . '.nominal', $detail->nominal) }}" oninput="formatNumber(this)">
                                    </td>
                                    <td>
