                    ...
                    <table class="table" id="dynamicTable">
                        ...
                        <tbody id="parentTbody">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="" id="nominal_{{ $index }}" oninput="formatNumber(this)" class="form-control text-end nominal" value="{{ number_format($detail->nominal_payment - $detail->discount, 0, '.', ',') }}" />
                                </td>
                                <td>
...
<script>
    ...
    let details = @json($payable_detail_pays);
