...
<head>
    <meta charset="UTF-8">
    <title>Payable Payment - {{ $generals->payable_payment_number }}</title>
    <style>
        .no-border {
            border: none;
        }
    ...
    <div class="container">
        <div class="details-container">
            <div class="company-details">
                <h2 style="text-align: center">Payable Payment</h2>
                ...
                <table class="table" style="width:100%">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="2" style="text-align: left">{{$generals->payable_payment_number}}</td>
                            <td colspan="2" style="text-align: center">{{$generals->supplier->supplier_name}}</td>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    @php
                        $totalNominal+=$detail->nominal_payment;
                    ...
                    <td style="text-align: right;">{{ number_format($detail->nominal_payment, 0,'.',',') }}</td>
