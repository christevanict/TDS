...
<div class="row">
    ...
    <div class="container content">
        <h2>REKAP {{__('Sales Invoice')}} Input</h2>


        <form id="si-form" action="{{ isset($salesInvoice) ? route('transaction.sales_invoice_recap.update', $salesInvoice->id) : route('transaction.sales_invoice_recap.store') }}" method="POST">
            @csrf
            ...
            <div class="modal fade" id="itemModal" tabindex="-1" aria-labelledby="selectInvoiceModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
...
function calculateTotals() {
    ...
    document.getElementById('department_code').addEventListener('change', function() {
            ...
            $.ajax({
                url: "{{ route('transaction.sales_invoice_recap.changeDepartment') }}",
                method: 'POST',
                data: {
