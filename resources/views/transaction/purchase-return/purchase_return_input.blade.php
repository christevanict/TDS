...
@section('content')
    ...
    <div class="container content">
        <h2>{{__('Purchase Return')}} Transaction</h2>
        <form id="po-form" action="{{ route('transaction.purchase_return.store') }}" method="POST">
            @csrf
            <div class="card mb-3">
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        if (id) {
                            ...
                            window.open("{{ route('transaction.purchase_return.print', ['id' => ':id']) }}".replace(':id', id), '_blank');
                        }
                    }
                });
            @endif
