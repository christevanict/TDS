...
@section('content')
<x-page-title title="REKAP {{__('Purchase Invoice')}}" pagetitle="REKAP {{__('Purchase Invoice')}} {{__('Information')}}" />
<hr>

<div class="card">
    <div class="card-body">
        <h6 class="mb-2 text-uppercase">REKAP {{__('Purchase Invoice')}} {{__('Information')}}</h6>
        <a class="btn btn-primary mb-3 @if(!in_array('create', $privileges)) disabled @endif" href="{{ route('transaction.purchase_invoice_recap.create') }}" >
            Tambah Baru
        </a>
            ...
            <table id="example" class="table table-hover table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr class="clickable-row">
                        ...
                        <td>
                            <a href="{{ route('transaction.purchase_invoice_recap.edit', $generals->id) }}" class="btn btn-warning btn-edit"><i class="material-icons-outlined">edit</i></a>
